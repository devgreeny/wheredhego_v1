...
def ensure_current_poll_exists():
    ...
    new_poll = Poll(
        ...
        description=f"Rank your top 25 college football teams for Week {current_week} of the {current_season} season. Voting opens Sunday 3pm EST and locks Thursday 3pm EST.",
        week_number=current_week,
        season_year=current_season,
