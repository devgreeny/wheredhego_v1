...
# Quiz files directory (relative to this script)
CURRENT_QUIZ_DIR = os.path.join(os.path.dirname(__file__), "static", "current_quiz")
PRELOADED_QUIZ_DIR = os.path.join(os.path.dirname(__file__), "preloaded_quizzes")
CFB_DATA_FILE = os.path.join(os.path.dirname(__file__), "CFB", "cbb25.csv")
